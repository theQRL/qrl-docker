# QRL node on Ubuntu 26.04 (Resolute).
#
...
#
# Branch-specific values (base tag, Python 3.14, runtime library package names)
...
LABEL org.opencontainers.image.title="qrl-docker" \
      org.opencontainers.image.description="QRL node on Ubuntu 26.04 Resolute" \
