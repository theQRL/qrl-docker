# QRL node on Ubuntu 24.04 (Noble).
#
...
#
# Branch-specific values (base tag, Python 3.12, runtime library package names)
...
LABEL org.opencontainers.image.title="qrl-docker" \
      org.opencontainers.image.description="QRL node on Ubuntu 24.04 Noble" \
